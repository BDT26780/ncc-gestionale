...
function Servizi({servizi,setServizi,clienti,driver,anno}){
  ...
  return <div>
    ...
    >
      ...
      <div style={{color:"#fff",fontFamily:"Georgia,serif",fontWeight:700,textAlign:"center",lineHeight:1.3,letterSpacing:3,textShadow:"3px 3px 0px #444,6px 6px 0px #222,8px 8px 12px rgba(0,0,0,0.8)",fontSize:cartelloPass.length<=6?"min(22vw,220px)":cartelloPass.length<=12?"min(18vw,180px)":cartelloPass.length<=18?"min(14vw,150px)":cartelloPass.length<=26?"min(10vw,120px)":"min(7vw,90px)",wordBreak:"normal",overflowWrap:"break-word",maxWidth:"90vw",padding:"0 30px",width:"100%"}}>{cartelloPass.toUpperCase()}</div>
      <div style={{width:80,height:1,background:"#c8a96e",opacity:0.6}}></div>
    </div>}
