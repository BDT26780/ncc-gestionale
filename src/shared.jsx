...
export const S={
  ...
  inp:{width:"100%",minWidth:0,maxWidth:"100%",background:"#0f1320",border:"1px solid #2d3550",borderRadius:6,color:"#e2e8f0",padding:"0 10px",height:34,lineHeight:"34px",fontSize:13,fontFamily:"inherit",boxSizing:"border-box"},
